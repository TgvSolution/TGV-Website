...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-primary-foreground overflow-hidden">
      {/* Navigation */}
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-background/80 backdrop-blur-md border-b border-primary/20 py-4" : "bg-transparent py-6"}`}
      >
        ...
        <div className="fixed inset-0 z-40 bg-background/95 backdrop-blur-xl pt-24 px-6 md:hidden flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4 text-lg mt-4">
            <button
              ...
              className={lang === "fr" ? "text-primary font-bold" : ""}
            >
              FR
            </button>
            <span className="text-border">|</span>
            <button
              ...
              className={lang === "en" ? "text-primary font-bold" : ""}
            >
              EN
            </button>
          </div>
          <a
            href="#contact"
            onClick={() => setIsMobileMenuOpen(false)}
            className="bg-primary text-primary-foreground text-center py-4 font-bold mt-4"
          >
            {t("nav.contact")}
          </a>
        </div>
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <motion.div
              variants={fadeIn}
              className="inline-flex items-center gap-2 px-3 py-1 border border-primary/30 bg-primary/5 text-primary text-xs font-bold tracking-widest uppercase mb-8"
            >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: Code,
                title: t("expertise.dev.title"),
                desc: t("expertise.dev.desc"),
              },
              {
                icon: Shield,
                title: t("expertise.arch.title"),
                desc: t("expertise.arch.desc"),
              },
              {
                icon: Server,
                title: t("expertise.scale.title"),
                desc: t("expertise.scale.desc"),
              },
            ].map((item, i) => (
              <motion.div
                key={i}
              ...
              >
                ...
                <item.icon
                  size={40}
                  className="text-primary mb-6 stroke-[1.5]"
                />
                <h3 className="text-xl font-serif font-medium mb-4 group-hover:text-primary transition-colors">
                  {item.title}
                </h3>
      ...
      <section id="products" className="py-32 relative">
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-primary font-bold hover:gap-4 transition-all uppercase tracking-wider text-sm border-b border-primary pb-1"
              >
            ...
            >
              <img
                src="/images/securfich-illustration.png"
                alt="SecurFich Interface"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                src="/images/tempett-dashboard.png"
                alt="Tempett GPS Route Management"
                className="w-full h-auto object-contain transition-all duration-700"
              />
            </motion.div>
            <motion.div
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-12 gap-12 mb-16">
            ...
            <div className="md:col-span-3 md:col-start-7">
              <h4 className="font-bold uppercase tracking-wider mb-6 text-sm">
                {t("footer.contact")}
              </h4>
